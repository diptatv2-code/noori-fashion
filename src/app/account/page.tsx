  ...
  if (!user) {
    return (
      <div className="max-w-md mx-auto px-4 py-16 text-center">
        <svg className="w-16 h-16 mx-auto text-dark-200 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
        <h1 className="font-display text-2xl font-semibold mb-2">My Account</h1>
        <p className="text-dark-400 text-sm mb-6">Sign in to view your orders and manage your account</p>
        <Link href="/login" className="btn-primary inline-block">Sign In</Link>
        <p className="text-sm text-dark-400 mt-4">Don&apos;t have an account? <Link href="/register" className="text-brand hover:underline">Register</Link></p>
      </div>
    );
  }
