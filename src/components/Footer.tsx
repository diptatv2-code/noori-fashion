    ...
    <footer className="bg-[#1A1A1A] text-white mt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="mb-4">
              <div className="bg-dark-700 rounded-lg inline-block px-2 py-1">
                <Image
                  src="/logo.jpg"
                  alt="Noori Fashion"
                  width={140}
            ...
            <p className="text-dark-300 text-sm leading-relaxed mb-4">
              Bangladesh&apos;s premium women&apos;s fashion brand. Exclusive
              collections, premium fabrics, and stunning designs for every
              occasion.
            </p>
            <div className="flex gap-3">
              <a
                href="https://www.facebook.com/p/Noori-Fashion-100069602142684/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 bg-white/10 flex items-center justify-center hover:bg-brand transition-colors rounded"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://wa.me/8801718389159"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 bg-white/10 flex items-center justify-center hover:bg-brand transition-colors rounded"
                aria-label="WhatsApp"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-dark-300">
              <li className="flex items-start gap-2">
                ...
                Police Plaza Concord, Gulshan-1, Level 2, Shop 369-370, Dhaka
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                Noori330332@gmail.com
              </li>
            </ul>
            <div className="mt-5">
              <p className="text-xs uppercase tracking-wider mb-2 text-dark-400">
                Payment Methods
              </p>
        ...
        <div className="border-t border-white/10 mt-10 pt-6 text-center text-xs text-dark-400">
          <p>
            &copy; {new Date().getFullYear()} Noori Fashion. All rights
            reserved.
          </p>
        </div>
      </div>
