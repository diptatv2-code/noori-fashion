          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              {product.compare_price && product.compare_price > product.price && (
                <>
                  ...
                  <span className="text-xs bg-red-100 text-red-700 px-2 py-0.5 font-medium">-{discount}% OFF</span>
                </>
              )}
            </div>
            {product.description && (
            ...
            {product.fabric_type && (
              <div className="mb-4 text-sm">
                <span className="text-dark-400">Fabric:</span>
              ...
              <div className="mb-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {sizes.map((s) => {
                    ...
                    return (
                      <button key={s} onClick={() => inStock && setSelectedSize(s)} disabled={!inStock}
            ...
            <div className="space-y-3 text-sm border-t border-dark-100 pt-5">
              <div className="flex items-center gap-2 text-dark-500">
                ...
                Dhaka ৳80 | Outside Dhaka ৳150 | Free on ৳5,000+
              </div>
              <div className="flex items-center gap-2 text-dark-500">
