...
const navItems = [
  ...
  { href: '/admin/products', label: 'প্রোডাক্ট', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
  { href: '/admin/categories', label: 'ক্যাটাগরি', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
  { href: '/admin/banners', label: 'ব্যানার', icon: 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z' },
    ...
    <div className="flex min-h-[calc(100vh-80px)]">
      ...
      <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-60 bg-dark-700 text-white transform transition-transform lg:transform-none ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        <div className="p-4 border-b border-white/10">
          <h2 className="font-display text-lg font-bold">নূরী <span className="text-brand">অ্যাডমিন</span></h2>
        </div>
        <nav className="py-3">
          {navItems.map((item) => (
            <Link
